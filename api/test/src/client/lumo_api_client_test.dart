...
void main() {
  ...
  group('LumoApiClient', () {
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => LumoApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
    ...
    group('getArticle', () {
      ...
      test(
          'throws LumoApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<LumoApiMalformedResponse>()),
        );
      });

      test(
          'throws LumoApiRequestFailure '
