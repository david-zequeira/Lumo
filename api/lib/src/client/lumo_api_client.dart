...
/// {@template lumo_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class LumoApiMalformedResponse implements Exception {
  /// {@macro lumo_api_malformed_response}
  const LumoApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template lumo_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class LumoApiRequestFailure implements Exception {
  /// {@macro lumo_api_request_failure}
  const LumoApiRequestFailure({
...
/// {@template lumo_api_client}
/// A Dart API client for the Lumo API.
/// {@endtemplate}
class LumoApiClient {
  /// Create an instance of [LumoApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro lumo_api_client}
  LumoApiClient({
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        LumoApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
