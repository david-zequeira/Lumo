  ...
  group('OnboardingBloc', () {
    ...
    group('EnableAdTrackingRequested', () {
      ...
      blocTest<OnboardingBloc, OnboardingState>(
        ...
        setUp: () => when(() => notificationsRepository.toggleNotifications(
            enable: any(named: 'enable'))).thenThrow(Exception()),
        build: () =>
            OnboardingBloc(notificationsRepository: notificationsRepository),
        act: (bloc) => bloc.add(EnableAdTrackingRequested()),
        expect: () =>
            <OnboardingState>[EnablingAdTracking(), EnablingAdTrackingFailed()],
      );
    });
