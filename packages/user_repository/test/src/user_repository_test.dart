...
import 'package:lumo_api/client.dart' as api;
...
class MockLumoApiClient extends Mock implements api.LumoApiClient {}
...
void main() {
  group('UserRepository', () {
    ...
    late MockLumoApiClient apiClient;
