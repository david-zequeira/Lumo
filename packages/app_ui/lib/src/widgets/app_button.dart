...
class AppButton extends StatelessWidget {
  ...
  /// Filled secondary button - Verde Forest de Lumo.
  ...
  /// Filled dark aqua button (deprecated - use primary instead).
  /// Mantenido por compatibilidad, ahora usa AppColors.primary (verde).
  ...
  /// Filled primary button - Verde Electric de Lumo.
  ...
  /// Para acciones menos prominentes.
