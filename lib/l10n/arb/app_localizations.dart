...
abstract class AppLocalizations {
  ...
  /// Bottom navigation bar habits tab label
  ///
  /// In en, this message translates to:
  /// **'Habits'**
  String get bottomNavBarHabits;

  /// Bottom navigation bar AI chat tab label
  ///
  /// In en, this message translates to:
  /// **'AI Chat'**
  String get bottomNavBarAIChat;

  /// Bottom navigation bar profile tab label
  ///
  /// In en, this message translates to:
  /// **'Profile'**
  String get bottomNavBarProfile;
  ...
  /// Emotion check-in title
  ///
  /// In en, this message translates to:
  /// **'How are you feeling today?'**
  String get emotionCheckInTitle;

  /// Emotion check-in title when updating
  ///
  /// In en, this message translates to:
  /// **'How are you feeling now?'**
  String get emotionCheckInTitleUpdate;

  /// Emotion check-in subtitle
  ///
  /// In en, this message translates to:
  /// **'Log your emotional state'**
  String get emotionCheckInSubtitle;

  /// Emotion registered confirmation
  ///
  /// In en, this message translates to:
  /// **'Emotion registered'**
  String get emotionRegistered;
  ...
  /// Energetic emotion label
  ///
  /// In en, this message translates to:
  /// **'Energetic'**
  String get emotionEnergetic;

  /// Anxious emotion label
  ///
  /// In en, this message translates to:
  /// **'Anxious'**
  ...
  /// In en, this message translates to:
  /// **'Online'**
  String get aiCompanionOnline;

  /// AI companion default message
  ///
  /// In en, this message translates to:
  /// **'Hello! How can I help you today?'**
  String get aiCompanionDefaultMessage;
  ...
  /// In en, this message translates to:
  /// **'Habits View'**
  String get habitsViewTitle;

  /// Meditation habit title
  ///
  /// In en, this message translates to:
  /// **'Meditate 10 minutes'**
  String get habitMeditation;

  /// Meditation habit description
  ///
  /// In en, this message translates to:
  ...
  String get habitReadingDesc;

  /// Exercise habit title
  ///
  /// In en, this message translates to:
  /// **'Exercise 30 min'**
  String get habitExercise;

  /// Exercise habit description
  ///
  /// In en, this message translates to:
  /// **'Physical activity'**
